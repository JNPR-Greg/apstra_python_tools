...
gen_srx_network_ps_type5.py
    ...
    the edge firewalls connected to that RefDes blueprint for Type 5
    interconnect between the blueprints.

    Copied from gen_srx_network_ps_vrf.py
    No updates yet.
'''
